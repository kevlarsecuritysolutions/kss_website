...
const HeroSection = () => {
  return (
    <section className="relative py-12 xl:pt-52 xl:pb-0 shadow-xl overflow-hidden">
      <div className="hidden xl:block absolute bottom-0 -left-12 z-10 w-[2000px] h-auto opacity-50">
      ...
      <div className="max-w-screen-2xl px-4 mx-auto relative pt-24 pb-6 lg:py-36 z-[20]">
        ...
        <h1 className=" text-4xl font-bold tracking-tight">
          <span className="block text-white uppercase xl:max-w-lg">
            Tasmanian owned security professionals
          </span>
        </h1>
