    ...
    <div className="relative">
      ...
      <div className="mx-auto">
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 lg:bottom-0 lg:inset-x-0 z-1">
            <StaticImage
          ...
          <div className="flex flex-col sm:grid sm:grid-cols-2 max-w-screen-2xl mx-auto px-4 py-12">
            <div className="relative lg:mt-24 px-4 py-16 sm:px-6 sm:py-24 lg:py-24 lg:px-8 z-[11]">
              <h1 className="text-left tracking-tight sm:text-6xl lg:text-7xl">
                <span className="block font-bold text-[#c3c9ce] uppercase font-heading text-5xl">
                  PROTECTION
                </span>
                <span className="block text-white font-heading uppercase text-5xl">
                  AT EVERY ANGLE
                </span>
              </h1>
              <div className="mt-8 max-w-sm sm:max-w-none sm:flex">
