    ...
    <>
      ...
      <section className="bg-gray-200">
        <div className="max-w-7xl text-kss-text mx-auto pt-36 pb-24">
          ...
          <h1 className="text-3xl font-semibold py-6">Interpretation and Definitions</h1>
          <h2 className="text-2xl font-semibold pb-6">Interpretation</h2>
          <p className="pb-4">
          ...
          <h2 className="text-2xl font-semibold pb-6">Definitions</h2>
          ...
          <ul className="list-disc pl-4 lg:pl-8">
            ...
            <li className="pb-4">
              <p>
                ...
                in this Agreement) refers to Kevlar Security Solutions, 80
                CHARLES STREET, Moonah Tasmania 7009.
              </p>
            </li>
            <li className="pb-4">
              <p>
            ...
            <li className="pb-4">
              <p>
                <strong>Country</strong> refers to: Tasmania, Australia
              </p>
            </li>
            <li className="pb-4">
              <p>
            ...
            <li className="pb-4">
              <p>
                <strong>Website</strong> refers to Kevlar Security Solutions,
                accessible from{" "}
                <a
                  href="https://kevlarsecuritysolutions.com.au"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://kevlarsecuritysolutions.com.au
                </a>
              </p>
            </li>
            <li className="pb-4">
          ...
          <h1 className="py-6 text-3xl font-semibold">Collecting and Using Your Personal Data</h1>
          <h2 className="text-2xl font-semibold pb-6">Types of Data Collected</h2>
          ...
          <h2 className="text-2xl font-semibold pb-6">Use of Your Personal Data</h2>
          ...
          <h2 className="text-2xl font-semibold pb-6">Retention of Your Personal Data</h2>
          <p className="pb-4">
          ...
          <h2 className="text-2xl font-semibold pb-6">Transfer of Your Personal Data</h2>
          <p className="pb-4">
          ...
          <h2 className="text-2xl font-semibold pb-6">Delete Your Personal Data</h2>
          <p className="pb-4">
          ...
          <h2 className="text-2xl font-semibold pb-6">Disclosure of Your Personal Data</h2>
          ...
          <h2 className="text-2xl font-semibold pb-6">Security of Your Personal Data</h2>
          <p className="pb-4">
          ...
          <h1 className="text-3xl font-semibold pb-6">Children's Privacy</h1>
          <p className="pb-4">
          ...
          <h1 className="text-3xl font-semibold pb-6">Links to Other Websites</h1>
          <p className="pb-4">
          ...
          <h1 className="text-3xl font-semibold pb-6">Changes to this Privacy Policy</h1>
          <p className="pb-4">
          ...
          <h1 className="text-3xl font-semibold pb-6">Contact Us</h1>
          <p className="pb-4">
          ...
          <ul className="list-disc pl-4 lg:pl-8">
            <li className="pb-4">
              <p>By email: info@kevlarsecuritysolutions.com.au</p>
            </li>
            <li className="pb-4">
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://kevlarsecuritysolutions.com.au/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://kevlarsecuritysolutions.com.au/contact
                </a>
              </p>
            </li>
            <li className="pb-4">
              <p>By phone number: 0408 303 603</p>
            </li>
          </ul>
        </div>
      </section>
