...
import { Email, Phone, Checkmark, Close } from "@carbon/icons-react";
          ...
          <div className="relative mx-auto max-w-screen-2xl lg:grid lg:grid-cols-5">
            <div className="bg-gray-100 py-12 px-4 sm:px-6 lg:col-span-2 lg:px-8 xl:pr-12">
              ...
              <p className="mt-4 pb-2 text-lg leading-6 text-kss-text">
                ...
                response phone number between 7am and 6pm. At all other times,
                you will be able to speak to one of our patrol drivers who can
                take your details and provide them to our CEO and Operations
                Manager.
              </p>
              <p className="mt-4 pb-2 text-lg leading-6 text-kss-text">
                Any urgent enquiries from new clients will receive a response
                from our CEO or Operations Manager within an hour of us
                receiving your call.
              </p>
              <p className="mt-4 pb-2 text-lg leading-6 text-kss-text">
                All non-urgent enquiries from new clients will receive a
                response from our CEO or Operations Manager within 24 hours.
              </p>
              <div className="pt-12">
