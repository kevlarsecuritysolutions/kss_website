  ...
  return (
    <Layout>
      ...
      <main className="bg-gradient-to-bl from-[#002034] to-black">
        ...
        >
          <div className="order-1 lg:order-2 px-4 pb-12 pt-24 lg:pb-24 lg:pl-24 lg:pr-24">
            <h2 className="mb-6 text-3xl font-bold uppercase text-white">
        ...
        {/* SITE CAMERAS SECTION */}
        <div id="site-cameras" className="grid grid-cols-1 lg:grid-cols-2">
          <div className="order-1 lg:order-2 px-4 pb-24 pt-24 lg:pl-24 lg:pr-24">
            <h2 className="mb-6 text-3xl font-bold uppercase text-white">
