  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="bg-gradient-to-bl from-[#002034] to-black py-16 overflow-hidden sm:px-6 lg:px-8 lg:py-24 lg:pt-36">
          <div className="relative mx-auto max-w-screen-2xl lg:grid lg:grid-cols-5">
            <div className="py-12 px-4 sm:px-6 lg:col-span-2 lg:px-8 xl:pr-12">
              ...
              <p className="mt-4 pb-2 text-lg leading-6 text-gray-300">
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-medium text-white">
                              Your submission has been received. Thank you for
                              your feedback.
                            </p>
                          </div>
