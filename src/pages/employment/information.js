...
const EmploymentInformation = () => {
  return (
    <Layout>
      <SEO title="Jobs at Kevlar Security Solutions Tasmania" description="Launch your security career in Tasmania. Apply for roles in patrol, guarding, IT and technical security at Kevlar." slug="/employment/information" />
          ...
          <div className="px-4 lg:pl-24 lg:pr-24 pt-24 pb-8">
            ...
            <div className="flex items-center max-w-lg pt-20 items-center">
              <Link to="/employment/expression-of-interest" className="w-24">
                <StaticImage src="../../assets/images/employment-icon.png" className="object-fit" alt="Apply for employment with KSS" />
              </Link>
